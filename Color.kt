...
object AppColors {
    ...
    // Orange Colors (Assuming from Chart/Level/Warning values)
    val Orange300 = Color(0xFFFF9238)
    val Orange400 = Color(0xFFFF9238) // Placeholder, actual value not in base palette
    val Orange500 = Color(0xFFFF9238) // Placeholder, actual value not in base palette

    // Yellow Colors (Assuming from Chart/Level/Normal values)
    val Yellow300 = Color(0xFFFF9238) // Placeholder, actual value not in base palette
    val Yellow400 = Color(0xFFFF9238) // Placeholder, actual value not in base palette
    val Yellow500 = Color(0xFFFF9238) // Placeholder, actual value not in base palette


    // Text Colors (Resolved from references)
    ...
    val TextError = Red500 // Using Red500 based on previous output, check if Red300 is more appropriate

    // Border Colors
    val BorderDefault = Grey350
    val BorderDivider = Grey550 // Grey550
    ...
    val ChartLevelWarning1 = Orange500 // Placeholder
    val ChartLevelWarning2 = Orange400 // Placeholder
    val ChartLevelWarning3 = Orange300
    val ChartLevelNormal1 = Yellow500 // Placeholder
    val ChartLevelNormal2 = Yellow400 // Placeholder
    val ChartLevelNormal3 = Yellow300 // Placeholder
